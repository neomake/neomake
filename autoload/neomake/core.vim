...
function! g:neomake#core#command_maker_base._get_fname_for_args(jobinfo) abort dict
    ...
    let _uses_stdin = neomake#utils#GetSetting('uses_stdin', self, g:neomake#config#undefined, a:jobinfo.ft, a:jobinfo.bufnr)
    if _uses_stdin isnot g:neomake#config#undefined
    ...
    if append_file || uses_filename || _uses_stdin
